...
<center><img src="Rozes Wings.PNG" width="150" height="150">
<img src="Gosling.png" align="right"  width="150" height="150"></center>
    <a href="rozesWings.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: Rozes Wings</th>
...
<body>
  <table>
    ...
    <hr class="new1">
  <center><h6>Note: Any errors occur then contact with Firoze.
Designed & Developed by Firoze</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved with Firoze :: 2015-2021</h6></center> 
  <hr class="new1">
</body>
<%}
	else{
		response.sendRedirect("errorRozesWingsOneView.html");
	}
}
	catch(Exception e){
		}
