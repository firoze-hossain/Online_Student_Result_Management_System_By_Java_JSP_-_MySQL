...
<!DOCTYPE html>
<html>
<title>Rozes Wings</title>
<body>
<img src="logo.png"  align="left"width="100" height="100">
<center><img src="Rozes Wings.PNG" width="100" height="100">
<img src="Gosling.png" align="right"  width="100" height="100"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Java Programming-CSC 383</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Theory Of Computation-CSC 397</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Discrete Mathematics-MAT 257</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Database Management-CSC 433</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Data Structures and Algorithms-CSC 391</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Software Engineering-CSE 469</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Operating System-CSC 307</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Roll Number</th>
          <th>Java Programming-CSC 383</th>
          <th>Theory Of Computation-CSC 397</th>
          <th>Discrete Mathematics-MAT 257 </th>
          <th>Database Management-CSC 433 </th>
          <th>Data Structures and Algorithms-CSC 391</th>
          <th>Software Engineering-CSC 469 </th>
          <th>Operating System-CSC 307</th>
        </tr>
      </thead>
    </table>
  </div>
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact with Firoze.
Designed & Developed by Firoze</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved with Firoze :: 2015-2021</h5></center> 
  <hr class="new1">
<br>
</body>
</html>